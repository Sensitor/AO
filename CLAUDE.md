...
api/migrations/        # Alembic (0001 schéma initial, 0002 documents+chunks)
```
...
- **Sprint 2 — À FAIRE (prochain)** : extraction des exigences (LLM, sortie JSON validée Pydantic) + écran de revue.
